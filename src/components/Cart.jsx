...
export default function Button({ theme, styled, click, children }) {
    ...
    return (<div className={` transition-all ease-in-out duration-300  z-40`}>
        <button type="button" onClick={() => setShowCart(!showCart)} class="h-[40px] w-[40px] my-1 text-blue-700 bg-[#0064FA] border border-gray-700 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
            ...
            <span className='inline-block absolute top-[10px] right-[10px] bg-white w-[16px] text-[12px] rounded-full border border-gray-950'>{
