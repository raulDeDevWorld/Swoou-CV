...
export default function Button({children}) {
    ...
    return (
        <div class="fixed top-0 left-0 w-screen flex p-4 mb-4 text-sm text-green-800 border border-green-400 rounded-lg bg-slate-300 " role="alert">
            ...
            <div>
                <span class="font-medium">Exitoso! </span>{children}
            </div>
        </div>
    )
}